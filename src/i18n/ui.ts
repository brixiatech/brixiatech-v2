...
export const ui = {
  it: {
    ...
    'realizzazioni.title': 'Installazioni reali, riprese al collaudo.',
    'realizzazioni.lead': 'Ogni clip mostra la commutazione così com’è avvenuta il giorno della consegna: dagli uffici direzionali agli ambienti sanitari, dalle teche espositive agli showroom dei partner.',
    'realizzazioni.video.aria': 'Video del collaudo:',
  ...
  en: {
    ...
    'realizzazioni.title': 'Real installations, filmed at handover.',
    'realizzazioni.lead': 'Each clip shows the switching exactly as it happened on delivery day: executive offices, healthcare practices, display cases, partner showrooms.',
    'realizzazioni.video.aria': 'Commissioning video:',
    'realizzazioni.p1.name': 'ENI',
