...
export const ui = {
  it: {
    ...
    'pillar.switchable.frame.body': 'Le tecnologie si distinguono per come cambiano stato. C’è chi commuta in modo netto, dal trasparente all’opaco, per creare privacy a comando: è la pellicola e il vetro switchable veri e propri. C’è chi regola la luce con continuità, come un dimmer. E c’è l’elettrocromico, che vira la tinta per schermare il sole tenendo la vista. Sapere quale comportamento serve è metà della scelta; il resto è capire dove ciascuna tecnologia dà il meglio.',
    ...
    'pillar.switchable.spd.body': 'L’SPD sta tra la commutazione e la tinta. Invece di passare tra trasparente e opaco, regola la luce attraverso una gamma di stati intermedi, come un dimmer per la luce del giorno. Va alimentato con continuità per mantenere un livello, il che lo rende adatto quando serve un controllo graduale di luce e abbagliamento più che un interruttore netto di privacy.',
  ...
  en: {
    ...
    'pillar.switchable.spd.body': 'SPD sits between switching and tinting. Rather than flipping between clear and opaque, it dims across a range of intermediate states, like a dimmer for daylight. It’s driven continuously to hold a level, which makes it a good fit where you want graduated control of light and glare rather than a hard privacy switch.',
    'pillar.switchable.spd.link': 'Smart Glass SPD',
