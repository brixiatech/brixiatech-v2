...
export const ui = {
  it: {
    // --- Meta / SEO ---
    'meta.title': 'Smart film e smart glass switchable | BrixiaTech',
    'meta.description':
      'Milano, Brescia, Bergamo: smart film e smart glass che passano da trasparenti a opachi a comando. Pellicole switchable, privacy e controllo solare.',
    'meta.ogLocale': 'it_IT',
    ...
    'techindex.compare.title': 'Le cinque tecnologie a confronto',
    'techindex.compare.col.pdlc': 'PDLC',
    'techindex.compare.col.pnlc': 'PNLC',
    'techindex.compare.col.spd': 'SPD',
    'techindex.compare.col.ec': 'EC',
    'techindex.compare.col.dlc': 'Blackout Hyper Glass',
    'techindex.compare.row.rest': 'Stato a riposo',
    'techindex.compare.rest.pdlc': 'Opaco, vista interrotta',
    'techindex.compare.rest.pnlc': 'Trasparente',
    'techindex.compare.rest.spd': 'Scuro, vista mantenuta',
    'techindex.compare.rest.ec': 'Ultima tinta impostata, vista mantenuta',
    'techindex.compare.rest.dlc': 'Scuro, vista interrotta',
    'techindex.compare.row.modulates': 'Cosa dosa',
    'techindex.compare.modulates.pdlc': 'Opacità',
    'techindex.compare.modulates.pnlc': 'Opacità',
    'techindex.compare.modulates.spd': 'Tinta',
    'techindex.compare.modulates.ec': 'Tinta',
    'techindex.compare.modulates.dlc': 'Tinta',
    'techindex.compare.row.light': 'Come agisce sulla luce',
    'techindex.compare.light.pdlc': 'Diffonde',
    'techindex.compare.light.pnlc': 'Diffonde',
    'techindex.compare.light.spd': 'Assorbe',
    'techindex.compare.light.ec': 'Assorbe',
    'techindex.compare.light.dlc': 'Assorbe',
    'techindex.compare.row.privacy': 'Privacy a comando',
    'techindex.compare.privacy.pdlc': 'Sì',
    'techindex.compare.privacy.pnlc': 'Sì',
    'techindex.compare.privacy.spd': 'No',
    'techindex.compare.privacy.ec': 'No',
    'techindex.compare.privacy.dlc': 'Sì',
    'techindex.compare.row.hold': 'Mantiene lo stato senza alimentazione',
    'techindex.compare.hold.pdlc': 'No',
    'techindex.compare.hold.pnlc': 'No',
    'techindex.compare.hold.spd': 'No',
    'techindex.compare.hold.ec': 'Sì',
    'techindex.compare.hold.dlc': 'No',
    'techindex.compare.row.primary': 'Funzione primaria',
    'techindex.compare.primary.pdlc': 'Privacy a comando',
    'techindex.compare.primary.pnlc': 'Privacy a comando, trasparente senza alimentazione',
    'techindex.compare.primary.spd': 'Controllo dell’abbagliamento',
    'techindex.compare.primary.ec': 'Controllo solare e termico',
    'techindex.compare.primary.dlc': 'Controllo solare, con privacy',
    'techindex.compare.row.supply': 'Canale di fornitura',
    'techindex.compare.supply.pdlc': 'Retrofit, stratifica, vetro finito',
    'techindex.compare.supply.pnlc': 'Retrofit, stratifica, vetro finito',
    'techindex.compare.supply.spd': 'Retrofit, stratifica, vetro finito',
    'techindex.compare.supply.ec': 'Stratifica e vetro finito',
    'techindex.compare.supply.dlc': 'Retrofit, stratifica, vetro finito',
    'techindex.solar.title': 'Prestazioni a confronto: SPD, elettrocromico e Blackout Hyper Glass',
    'techindex.solar.col.spd': 'SPD',
    'techindex.solar.col.ec': 'EC',
    'techindex.solar.col.dlc': 'Blackout Hyper Glass',
    'techindex.solar.row.cond': 'Condizione di misura',
    'techindex.solar.cond.spd': 'Film',
    'techindex.solar.cond.ec': 'Vetrocamera 5+12+5, argon',
    'techindex.solar.cond.dlc': 'Film',
    'techindex.solar.row.trans': 'Trasmissione luminosa (trasparente / scuro)',
    'techindex.solar.trans.spd': '40% / 1%',
    'techindex.solar.trans.ec': '55% / 1%',
    'techindex.solar.trans.dlc': '31% / 1,65%',
    'techindex.solar.row.g': 'Fattore solare g (trasparente / scuro)',
    'techindex.solar.g.spd': '0,38 / 0,05',
    'techindex.solar.g.ec': '0,48 / 0,09',
    'techindex.solar.g.dlc': '0,58 / 0,42',
    'techindex.solar.row.ir': 'Blocco infrarosso (trasparente / scuro)',
    'techindex.solar.ir.spd': '50% / 90%',
    'techindex.solar.ir.ec': '—',
    'techindex.solar.ir.dlc': '15% / 85%',
    'techindex.solar.row.uv': 'Blocco UV, pellicola adesiva',
    'techindex.solar.uv.spd': '99,9%',
    'techindex.solar.uv.ec': '—',
    'techindex.solar.uv.dlc': '99%',
    'techindex.solar.row.volt': 'Tensione di alimentazione',
    'techindex.solar.volt.spd': '110 V AC',
    'techindex.solar.volt.ec': 'Bassa tensione',
    'techindex.solar.volt.dlc': '48 V AC o 60 V AC',
    'techindex.solar.row.power': 'Consumo',
    'techindex.solar.power.spd': '5 W/m² in commutazione, 3 W/m² a regime',
    'techindex.solar.power.ec': '0,2 W/m² in transizione, nullo a stato raggiunto',
    'techindex.solar.power.dlc': '5 W/m² a regime',
    'techindex.solar.row.time': 'Tempo di transizione',
    'techindex.solar.time.spd': 'Fino a 3 s',
    'techindex.solar.time.ec': '~15 min',
    'techindex.solar.time.dlc': 'Istantaneo, come il PDLC',
    'techindex.solar.row.size': 'Dimensione massima',
    'techindex.solar.size.spd': 'Rotolo da 150 cm',
    'techindex.solar.size.ec': 'Elemento 1000 × 1500 mm',
    'techindex.solar.size.dlc': 'Rotolo da 150 cm',
    'techindex.solar.note': 'SPD e Blackout Hyper Glass misurati su film; elettrocromico su vetrocamera 5 mm + film + 12 mm argon + 5 mm, secondo JGJ/T 151-2008, con quattro livelli di tinta impostabili tra gli estremi indicati. Il blocco UV è proprio della pellicola adesiva; le versioni da stratifica lo acquisiscono con l’intercalare EVA. Valori di scheda tecnica: in opera dipendono dalla stratigrafia del vetro.',
    ...
    'insights.negozio.meta.description': 'Vetrina da trasparente a opaca a comando: privacy fuori orario e protezione UV per la merce esposta. Come coprire i vetri senza tende né pannelli.',
    ...
    'insights.negozio.merce.body': 'La luce che mette in mostra i prodotti è la stessa che li deteriora: i raggi ultravioletti sono la causa principale dello scolorimento di tessuti, packaging, pelle e stampati. Tutte le nostre pellicole switchable — PDLC, PNLC, SPD e Blackout — filtrano la quasi totalità degli UV: la protezione dell’esposto non dipende dalla tecnologia né dal colore scelti. Il controllo del calore e dell’abbagliamento dipende invece dallo stato in cui si trova la pellicola — trasparente, opaca o scura — ed è qui che le versioni colorate e tecnologie come SPD ed elettrocromico fanno la differenza per il comfort termico di una vetrina esposta al sole.',
    ...
    'insights.veneziane.stato.veneziana': 'Guarda la veneziana elettronica',
    ...
    'realizzazioni.p1.tech': 'PDLC Premium',
    'realizzazioni.p2.name': 'Panerai',
    'realizzazioni.p2.place': 'Watches and Wonders, Ginevra',
    'realizzazioni.p2.tech': 'Blackout Hyper Glass',
    'realizzazioni.p3.name': 'W Executive',
    'realizzazioni.p3.place': 'Milano',
    'realizzazioni.p3.tech': 'Veneziana elettronica su PDLC',
    'realizzazioni.p4.name': 'Teca espositiva per Leva Engineering',
    'realizzazioni.p4.place': 'Qatar',
    'realizzazioni.p4.tech': 'PDLC Premium',
    'realizzazioni.p5.name': 'Showroom EFFEGIEFFE',
    ...
    'pillar.switchable.faq.a5': 'Sì: le pellicole switchable bloccano la grande maggioranza dei raggi ultravioletti, a protezione di interni e arredi.',
  ...
  en: {
    ...
    'techindex.compare.title': 'The five technologies compared',
    'techindex.compare.col.pdlc': 'PDLC',
    'techindex.compare.col.pnlc': 'PNLC',
    'techindex.compare.col.spd': 'SPD',
    'techindex.compare.col.ec': 'Electrochromic (EC)',
    'techindex.compare.col.dlc': 'Blackout Hyper Glass',
    'techindex.compare.row.rest': 'At rest, unpowered',
    'techindex.compare.rest.pdlc': 'Opaque, view cut',
    'techindex.compare.rest.pnlc': 'Clear',
    'techindex.compare.rest.spd': 'Dark, view intact',
    'techindex.compare.rest.ec': 'Holds the last tint set, view intact',
    'techindex.compare.rest.dlc': 'Dark, view cut',
    'techindex.compare.row.modulates': 'What it modulates',
    'techindex.compare.modulates.pdlc': 'Opacity',
    'techindex.compare.modulates.pnlc': 'Opacity',
    'techindex.compare.modulates.spd': 'Tint',
    'techindex.compare.modulates.ec': 'Tint',
    'techindex.compare.modulates.dlc': 'Tint',
    'techindex.compare.row.light': 'How it acts on light',
    'techindex.compare.light.pdlc': 'Scatters',
    'techindex.compare.light.pnlc': 'Scatters',
    'techindex.compare.light.spd': 'Absorbs',
    'techindex.compare.light.ec': 'Absorbs',
    'techindex.compare.light.dlc': 'Absorbs',
    'techindex.compare.row.privacy': 'Privacy on command',
    'techindex.compare.privacy.pdlc': 'Yes',
    'techindex.compare.privacy.pnlc': 'Yes',
    'techindex.compare.privacy.spd': 'No',
    'techindex.compare.privacy.ec': 'No',
    'techindex.compare.privacy.dlc': 'Yes',
    'techindex.compare.row.hold': 'Holds its state unpowered',
    'techindex.compare.hold.pdlc': 'No',
    'techindex.compare.hold.pnlc': 'No',
    'techindex.compare.hold.spd': 'No',
    'techindex.compare.hold.ec': 'Yes',
    'techindex.compare.hold.dlc': 'No',
    'techindex.compare.row.primary': 'Primary function',
    'techindex.compare.primary.pdlc': 'Privacy on command',
    'techindex.compare.primary.pnlc': 'Privacy on command, clear on power loss',
    'techindex.compare.primary.spd': 'Glare control',
    'techindex.compare.primary.ec': 'Solar and thermal control',
    'techindex.compare.primary.dlc': 'Solar control, with privacy',
    'techindex.compare.row.supply': 'Supply channel',
    'techindex.compare.supply.pdlc': 'Retrofit, lamination, finished glass',
    'techindex.compare.supply.pnlc': 'Retrofit, lamination, finished glass',
    'techindex.compare.supply.spd': 'Retrofit, lamination, finished glass',
    'techindex.compare.supply.ec': 'Lamination and finished glass',
    'techindex.compare.supply.dlc': 'Retrofit, lamination, finished glass',
    'techindex.solar.title': 'Performance compared: SPD, electrochromic and Blackout Hyper Glass',
    'techindex.solar.col.spd': 'SPD',
    'techindex.solar.col.ec': 'Electrochromic (EC)',
    'techindex.solar.col.dlc': 'Blackout Hyper Glass',
    'techindex.solar.row.cond': 'Test condition',
    'techindex.solar.cond.spd': 'Film',
    'techindex.solar.cond.ec': 'Insulating unit 5+12+5, argon',
    'techindex.solar.cond.dlc': 'Film',
    'techindex.solar.row.trans': 'Visible light transmission (clear / dark)',
    'techindex.solar.trans.spd': '40% / 1%',
    'techindex.solar.trans.ec': '55% / 1%',
    'techindex.solar.trans.dlc': '31% / 1.65%',
    'techindex.solar.row.g': 'Solar factor g (clear / dark)',
    'techindex.solar.g.spd': '0.38 / 0.05',
    'techindex.solar.g.ec': '0.48 / 0.09',
    'techindex.solar.g.dlc': '0.58 / 0.42',
    'techindex.solar.row.ir': 'Infrared blocked (clear / dark)',
    'techindex.solar.ir.spd': '50% / 90%',
    'techindex.solar.ir.ec': '—',
    'techindex.solar.ir.dlc': '15% / 85%',
    'techindex.solar.row.uv': 'UV blocked, adhesive film',
    'techindex.solar.uv.spd': '99.9%',
    'techindex.solar.uv.ec': '—',
    'techindex.solar.uv.dlc': '99%',
    'techindex.solar.row.volt': 'Supply voltage',
    'techindex.solar.volt.spd': '110 V AC',
    'techindex.solar.volt.ec': 'Low voltage',
    'techindex.solar.volt.dlc': '48 V AC or 60 V AC',
    'techindex.solar.row.power': 'Power draw',
    'techindex.solar.power.spd': '5 W/m² while switching, 3 W/m² steady',
    'techindex.solar.power.ec': '0.2 W/m² while shifting, none once set',
    'techindex.solar.power.dlc': '5 W/m² steady',
    'techindex.solar.row.time': 'Transition time',
    'techindex.solar.time.spd': 'Up to 3 s',
    'techindex.solar.time.ec': '~15 min',
    'techindex.solar.time.dlc': 'Instant, like PDLC',
    'techindex.solar.row.size': 'Maximum size',
    'techindex.solar.size.spd': '150 cm roll width',
    'techindex.solar.size.ec': '1000 × 1500 mm unit',
    'techindex.solar.size.dlc': '150 cm roll width',
    'techindex.solar.note': 'SPD and Blackout Hyper Glass measured as film; electrochromic measured as an insulating unit, 5 mm + film + 12 mm argon + 5 mm, per JGJ/T 151-2008, with four tint levels settable between the extremes shown. UV blocking belongs to the adhesive film; laminated versions acquire it through the EVA interlayer. Datasheet values: on-site behaviour depends on the glass build-up.',
    ...
    'insights.negozio.meta.description': 'Shop windows from clear to opaque on command: after-hours privacy and UV protection for displayed goods. How to cover the glass with no blinds or panels.',
    ...
    'insights.negozio.merce.body': 'The light that shows products off is the very light that degrades them: ultraviolet rays are the main cause of fading in textiles, packaging, leather and print. All our switchable films — PDLC, PNLC, SPD and Blackout — filter out almost all UV: protection for the display does not depend on the technology or colour chosen. Heat and glare control, by contrast, depends on the state the film is in — clear, opaque or dark — and this is where coloured versions and technologies such as SPD and electrochromic make the difference for the thermal comfort of a window in full sun.',
    ...
    'insights.veneziane.stato.body': 'Switchable glass takes a different route: no slats in front of the pane — the surface itself turns from clear to opaque on command. A film applied to existing glass — or an active glass unit, for new builds — switches in an instant, silently, with no mechanics to wear out. The glazing stays clean to the eye, nothing protrudes, and a retrofit doesn’t require replacing the frame. An alternative configuration is also available: the Venetian effect — horizontal bands on the same film, the venetian look from the switching surface itself, with no slats and no motors.',
    'insights.veneziane.stato.veneziana': 'See the Venetian effect',
    ...
    'realizzazioni.p1.tech': 'PDLC Premium',
    'realizzazioni.p2.name': 'Panerai',
    'realizzazioni.p2.place': 'Watches and Wonders, Geneva',
    'realizzazioni.p2.tech': 'Blackout Hyper Glass',
    'realizzazioni.p3.name': 'W Executive',
    ...
    'realizzazioni.p4.place': 'Qatar',
    'realizzazioni.p4.tech': 'PDLC Premium',
    'realizzazioni.p5.name': 'EFFEGIEFFE showroom',
    ...
    'pillar.switchable.faq.a5': 'Yes: switchable films block the vast majority of ultraviolet light, protecting interiors and furnishings.',
